<script lang="ts">
  ...
  if (window.localStorage.getItem('ruby') === null) {
    window.localStorage.setItem('ruby', '0');
  }

  if (window.localStorage.getItem('sapphire') === null) {
    window.localStorage.setItem('sapphire', '0');
  }
